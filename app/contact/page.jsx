    ...
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] transition-colors relative">
      ...
      <section className="relative pt-32 md:pt-48 pb-16 md:pb-24 overflow-hidden border-b border-slate-100 dark:border-white/5 bg-transparent">
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <h1 className="animate-hero-fade-up [animation-delay:100ms] text-6xl md:text-8xl lg:text-7xl font-bold text-slate-900 dark:text-white leading-[0.9] mb-8 tracking-tight">
            Let’s Engineer <br />
          ...
          <p className="animate-hero-fade-up [animation-delay:200ms] text-xl md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed mb-12 font-medium">
          ...
          <div className="animate-hero-fade-up [animation-delay:300ms] flex justify-center items-center gap-4">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-10 h-10 md:w-12 md:h-12 rounded-full border-4 border-white dark:border-[#0d0d0d] bg-slate-200 overflow-hidden shadow-xl"
                >
                  <img
            ...
            <div className="text-left">
              ...
              <p className="text-[11px] font-bold text-[#002147] dark:text-blue-400 mt-1">
                Active Now
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 space-y-5">
            ...
            <div className="grid grid-cols-1 gap-4">
              {[
                ...
                <div 
                  key={idx}
                  className={`animate-hero-fade-up group p-8 md:p-10 bg-slate-50 dark:bg-white/5 rounded-3xl border border-slate-200 dark:border-white/5 shadow-sm hover:border-[#002147]/30 dark:hover:border-blue-500/30 transition-all duration-300`}
