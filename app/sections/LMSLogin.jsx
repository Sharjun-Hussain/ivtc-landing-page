      ...
      <div className="max-w-6xl mx-auto px-6">
        <ScrollReveal>
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 -mb-20 -ml-20 w-64 h-64 bg-indigo-500/10 rounded-full blur-[80px] mobile-optimize-blur group-hover:bg-indigo-500/20 transition-colors duration-700" />

            <div className="relative z-10 grid lg:grid-cols-2 gap-8 lg:gap-14 items-center">
              {/* Main Content Area */}
              <div className="space-y-6 md:space-y-8">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 text-white/90 text-[9px] md:text-sm font-medium tracking-widest uppercase">
              ...
              <div className="relative">
                ...
                <div className="mt-4 p-5 rounded-[1.5rem] bg-linear-to-r from-white/10 to-transparent border border-white/10 backdrop-blur-xl flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-white/40 text-[9px] font-bold uppercase tracking-wider">Growing daily</div>
                  </div>
                </div>
              </div>
            </div>
