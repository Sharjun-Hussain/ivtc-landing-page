  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6">
        <div
          className={`relative group overflow-hidden rounded-[2rem] bg-linear-to-br from-[#002147] via-[#003366] to-[#001a35] p-6 md:p-10 lg:p-14 shadow-2xl mobile-no-shadow border border-white/5 opacity-0 ${isVisible ? 'animate-hero-fade-up' : ''}`}
        >
          {/* Decorative Glows */}
