...
const InputField = React.memo(({ label, icon: Icon, className, ...props }) => (
  <div className={cn("space-y-1.5", className)}>
    ...
    <div className="relative group">
      ...
      />
      <input
        className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white rounded-lg py-2.5 pl-10 pr-3 text-sm focus:border-[#002147] focus:ring-1 focus:ring-[#002147]/30 outline-none transition-all font-medium"
        {...props}
      />
    </div>
  </div>
  ...
  <div className={cn("space-y-1.5", className)}>
    ...
    <div className="relative group">
      ...
      <select
        ...
        value={value}
        onChange={onChange}
        className="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white rounded-lg py-2.5 pl-10 pr-8 text-sm focus:border-[#002147] focus:ring-1 focus:ring-[#002147]/30 outline-none transition-all font-medium appearance-none cursor-pointer"
      >
    ...
    >
      <div className="max-w-6xl mx-auto px-4 md:px-6 relative z-10">
        ...
        <header className="mb-8">
          <h3 className="anim-header text-[#002147] dark:text-blue-400 font-mono tracking-widest uppercase text-[10px] md:text-xs mb-3 font-bold">
            / Spring 2026 Intake
          </h3>
          ...
          <h2 className="anim-header text-3xl md:text-5xl font-bold text-slate-900 dark:text-white tracking-tighter">
            Begin Your{" "}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-[#002147] to-blue-900 dark:from-blue-400 dark:to-blue-600">
              Legendary
            </span>{" "}
            Journey.
          </h2>
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    "anim-card group relative p-4 rounded-xl border cursor-pointer transition-all duration-300 flex flex-col justify-between shrink-0",
                    "min-w-[280px] lg:min-w-0 snap-center",
                    isActive 
                      ? "bg-slate-50 dark:bg-white/5 border-[#002147] shadow-lg shadow-blue-900/10" 
                ...
                >
                  <div>
                    <div className="flex items-start justify-between mb-3">
                      <div className={cn(
                        ...
                        isActive ? "bg-[#002147] text-white" : "bg-slate-100 dark:bg-white/5 text-slate-400"
                      )}>
                        <type.icon size={20} />
                      </div>
                      {isActive && <CheckCircle className="h-5 w-5 text-[#002147]" />}
                    </div>
                    <h4 className={cn(
                  ...
                  <div className="mt-3 flex items-center justify-between text-[10px] font-bold uppercase tracking-widest text-slate-400 group-hover:text-[#002147] transition-colors">
          ...
          <div className="lg:col-span-8 anim-form-container" ref={formTopRef}>
            ...
            <div className="bg-white dark:bg-[#111] border border-slate-200 dark:border-white/5 rounded-2xl p-6 md:p-8 shadow-xl">
              ...
              <form onSubmit={(e) => { e.preventDefault(); alert("Submitted!"); }} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-[#002147] dark:bg-blue-600 text-white font-bold py-4 rounded-xl hover:bg-[#003366] dark:hover:bg-blue-500 transition-all flex items-center justify-center gap-2 text-base shadow-lg shadow-blue-900/10 active:scale-[0.99] mt-2"
                >
