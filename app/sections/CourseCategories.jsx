    ...
    <section ref={sectionRef} className="py-24 bg-white dark:bg-[#0a0a0a] transition-colors duration-500 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <header className="mb-16">
          <h3 className="text-blue-500 dark:text-slate-400 font-mono tracking-widest uppercase text-xs mb-4">
            / Educational Expertise
          </h3>
          <h2 className="text-5xl md:text-7xl font-bold text-slate-900 dark:text-white tracking-tighter">
            Choose your{" "}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-indigo-600 dark:from-white dark:to-slate-400">
              Legendary
            </span>{" "}
            <br /> Career Path.
          </h2>
          ...
          {pathways.map((item, i) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className="icon-wrapper w-14 h-14 rounded-2xl border border-slate-200 dark:border-white/10 flex items-center justify-center text-blue-500 dark:text-white mb-8 transition-colors">
                  {item.icon}
                </div>
                ...
                <h4 className="text-2xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-blue-400 dark:group-hover:text-slate-300 transition-colors duration-300">
                  {item.title}
                </h4>
              ...
              <div className="relative z-10 flex items-center justify-between">
                <span className="text-slate-900 dark:text-white text-xs font-bold flex items-center gap-2 group-hover:gap-4 transition-all duration-300">
                  EXPLORE PATH{" "}
                  <ArrowRight size={14} className="text-blue-500 dark:text-white" />
                </span>
