        ...
        <section className="fade-up">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredResources.map((res, i) => (
              <div key={i} className="group relative bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-[2.5rem] p-8 hover:shadow-2xl transition-all overflow-hidden">
