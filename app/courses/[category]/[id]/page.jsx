  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        <ScrollReveal>
          {/* --- 1. BREADCRUMBS --- */}
          <nav className="flex items-center gap-2 mb-8 text-xs font-bold uppercase text-slate-400">
            <Link
              href="/"
          ...
          <div className="grid lg:grid-cols-12 gap-8 mb-20">
            <div className="lg:col-span-7 space-y-6">
              ...
              <h1 className="text-5xl md:text-7xl font-bold text-slate-900 dark:text-white leading-[0.9] mb-4">
                Enterprise <br />{" "}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[1, 2, 3].map((item) => (
              <ScrollReveal key={item}>
                <div
                  className="group bg-white dark:bg-[#111] rounded-[2.5rem] p-8 border border-slate-100 dark:border-white/5 shadow-[0_20px_50px_rgba(0,0,0,0.05)] hover:shadow-2xl hover:border-blue-500/30 transition-all duration-500"
                >
