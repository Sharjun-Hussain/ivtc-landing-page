...
const CourseCarousel = ({ courses, isVisible }) => {
  return (
            ...
            >
              <div className="group h-full bg-white dark:bg-[#0a0a0a] rounded-[2.5rem] border border-slate-200 dark:border-white/5 overflow-hidden transition-all duration-500 hover:shadow-2xl hover:border-[#002147] dark:hover:border-blue-500/50 flex flex-col">
                ...
                <div className="p-8 flex flex-col flex-1 text-left">
                  ...
                  <a
                    href="/#registration"
                    className="inline-flex items-center justify-center w-full py-4 bg-[#002147] hover:bg-blue-900 dark:bg-white dark:text-black dark:hover:bg-slate-200 text-white rounded-2xl text-sm transition-all group/btn font-semibold"
                  >
                    Register Now
